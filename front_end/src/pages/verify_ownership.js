...
export const Verify=()=>{
    ...
    const func =async()=>{
        const response =await fetch('http://127.0.0.1:5000//checkOwner/'+wal+'/'+document.forms["VERIFYFORM"]["nft_val"].value,{
            method:'GET',
            mode:'cors',
        ...
        if (body['result']==='False'){
            setResult(<Grid>
                <Paper elevation={10} style={paperStyle}>
                    <div>
                    <div style={{fontSize:20,fontFamily: '"Roboto", "Helvetica", "Arial", sans-serif'}}>EITHER YOU DON'T OWN THIS TOKEN</div>
                    <div style={{fontSize:20,fontFamily: '"Roboto", "Helvetica", "Arial", sans-serif'}}>OR</div>
                    <div  style={{fontSize:20,fontFamily: '"Roboto", "Helvetica", "Arial", sans-serif'}}>THIS TOKEN DOESN'T EXIST</div>
                    </div>
                </Paper>
            </Grid>)
        }
            ...
            setResult(<Grid>
                <Paper elevation={10} style={paperStyle}>
                <div style={{fontSize:20,fontFamily: '"Roboto", "Helvetica", "Arial", sans-serif'}}>YES! YOU OWN THIS TOKEN</div>
                </Paper>
            </Grid>)
        }
        // setResult(body['abcd'])
    ...
    return(
        ...
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                ...
                <Button type='submit' color='primary' variant="contained" style={btnstyle} fullWidth>VERIFY OWNERSHIP</Button>
