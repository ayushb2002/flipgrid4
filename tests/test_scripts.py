import pytest
from scripts.deploy import deploy_seller_to_buyer_transaction, expire, items_for_sale, items_for_sale_address, customerAddress, customerAddress2, buyerToBuyer
...
def test_nft_can_expire():
    result = expire(customer=customerAddress, expiry=0)
    assert result == True
